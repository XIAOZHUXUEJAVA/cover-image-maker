...
import { HelpCircle, Keyboard, Settings, Layout, Palette, Image, Monitor } from "lucide-react"
...
export function UsageGuide() {
  ...
  const controlsGuide = [
    {
      ...
      items: [
        { name: "画布尺寸", description: "设置封面的宽度和高度，支持常见尺寸预设" },
    ...
    },
    {
      ...
      items: [
        ...
        { name: "副标题", description: "设置封面的副标题或描述文字，最多100个字符" },
        { name: "标题字号", description: "调整主标题的字体大小，范围24-120px" },
        { name: "副标题字号", description: "调整副标题的字体大小，范围12-64px" },
        { name: "标题颜色", description: "设置主标题的文字颜色，支持颜色选择器和预设颜色" },
        { name: "副标题颜色", description: "设置副标题的文字颜色，支持颜色选择器和预设颜色" },
        { name: "字体", description: "选择字体样式：Geist Sans、Geist Mono或System UI" },
      ]
    },
    {
      category: "样式设置",
      ...
      items: [
        ...
        { name: "风格预设", description: "快速应用预设风格：简约、清新、商务、科技、温暖、优雅" },
        { name: "自动对比色", description: "根据背景自动调整文字颜色以确保可读性" },
    ...
    },
    {
      ...
      items: [
        { name: "对齐方式", description: "设置文字的水平对齐：左对齐、居中、右对齐" },
        { name: "垂直位置", description: "设置文字的垂直位置：顶部、居中、底部" },
        { name: "内边距", description: "调整文字与画布边缘的距离，范围8-160px" },
        { name: "文本最大宽度", description: "限制文字的最大宽度占比，范围30-100%" },
      ]
    },
    {
      category: "背景设置",
      ...
      items: [
        { name: "背景缩放", description: "调整背景图片的缩放比例，范围50-300%" },
        { name: "水平偏移", description: "调整背景图片的水平位置，范围-200%到200%" },
        { name: "垂直偏移", description: "调整背景图片的垂直位置，范围-200%到200%" },
  ...
  const quickActions = [
    ...
    { name: "撤销/重做", description: "使用历史工具栏或快捷键进行操作撤销和重做" },
  ]
              ...
              {controlsGuide.map((category, index) => (
                <div key={index} className="space-y-3">
                  ...
                  <div className="grid gap-3 md:grid-cols-1">
                    {category.items.map((item, itemIndex) => (
                      <div key={itemIndex} className="p-3 border rounded-lg space-y-1">
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <strong>设置画布：</strong>在"画布"标签页选择合适的尺寸和比例
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <strong>添加内容：</strong>在"内容"标签页输入标题和副标题，调整字体大小和颜色
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <strong>选择背景：</strong>在"背景"标签页上传图片或选择示例图片，调整位置和缩放
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <strong>调整样式：</strong>在"样式"标签页设置遮罩效果，或直接选择风格预设
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 bg-primary text-primary-foreground rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0">5</div>
                <div>
                  <strong>优化布局：</strong>在"布局"标签页调整文字对齐和位置
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 bg-primary text-primary-foreground rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0">6</div>
                <div>
                  <strong>导出封面：</strong>完成后点击下方的"下载 PNG"或"下载 JPG"按钮
                </div>
              </div>
            </div>
          </div>
